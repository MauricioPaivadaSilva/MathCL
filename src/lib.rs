...
mod tests {
    ...
    #[test]
    fn sum_1(){
        assert_eq!(sum(1.0, 1), 2.0)
    }

    #[test]
    fn sum_2(){
        assert_eq!(sum(1.0, 10), 11.0)
    }

    #[test]
    fn sum_3(){
        assert_eq!(sum(3.0, 3), 12.0)
    }
    ...
    #[test]
    fn module_1() {
        assert_eq!(module(2.0), 2.0)
    }

    #[test]
    fn module_2() {
        assert_eq!(module(0.0), 0.0)
    }

    #[test]
    fn module_3() {
        assert_eq!(module(-442.0), 442.0)
    }

    #[test]
    fn pow_1() {
        assert_eq!(pow(-2.0, 2), 4.0)
    }
